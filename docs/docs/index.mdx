...
You can find the docs on how to get started quickly in the [development guides](https://anubis.techaro.lol/docs/category/developer-guides), You can find seperate guides on setting Anubis up with [Apache](https://anubis.techaro.lol/docs/admin/environments/apache), [Caddy](https://anubis.techaro.lol/docs/admin/environments/caddy), [Docker Compose](https://anubis.techaro.lol/docs/admin/environments/docker-compose), [Kubernetes](https://anubis.techaro.lol/docs/admin/environments/docker-compose), [Nginix](https://anubis.techaro.lol/docs/admin/environments/nginx) and [Traefik](https://anubis.techaro.lol/docs/admin/environments/traefik) in there!
