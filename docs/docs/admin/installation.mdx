...
```
For more detailed information on how to integrate with traefik, please refer to [Integrate Anubis with Traefik in a Docker Compose Environment](./configuration/traefik-integration.mdx) page.
