...
| `COOKIE_PARTITIONED`           | `true`                  | If set to `true`, enables the [partitioned (CHIPS) flag](https://developers.google.com/privacy-sandbox/cookies/chips), meaning that Anubis inside an iframe has a different set of cookies than the domain hosting the iframe. This should be enabled. Do not disable it unless you have a very good reason. Disabling this flag makes Google Chrome sometimes not store cookies.                                                                                                                                                              |
| `COOKIE_PREFIX`                | `techaro.lol-anubis`    | The prefix used for browser cookies created by Anubis. Useful for customization or avoiding conflicts with other applications. Change this if you need to apply branding to Anubis' cookie names for regulatory reasons.                                                                                                                                                                                                                                                                                                                       |
