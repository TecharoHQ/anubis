...
# Integrate Anubis with Traefik in a Docker Compose Environment
...
user-->|:443 - Requestiong Service|traefik
...
services:
  ...
  anubis:
    ...
    environment:
      ...
      - BIND=:8080
      # Telling Anubis to redirect to the internal Docker Network to Traefik
      - TARGET=http://traefik:3923
    networks:
      - traefik
    labels:
