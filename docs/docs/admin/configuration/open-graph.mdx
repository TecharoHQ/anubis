...
If you enable this, make sure your application renders only the minimal HTML for OpenGraph metadata when you get the User-Agent string `Anubis-OGTag-Fetcher/1.0`. Otherwise you will incur massive load on protected pages that have never been referenced before.
...
When Open Graph passthrough is enabled, Anubis will:
