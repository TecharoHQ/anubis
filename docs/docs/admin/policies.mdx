...
This would remove five weight points from the request, making Anubis more forgiving.
...
|                 `weight < 10` (weight is less than 10) | Challenge the client with the [Meta Refresh challenge](./challenges/metarefresh.mdx) at the default difficulty level.    |
| `weight >= 10` (weight is greater than or equal to 10) | Challenge the client with the [Proof of Work challenge](./challenges/proof-of-work.mdx) at the default difficulty level. |
