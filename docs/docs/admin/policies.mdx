...
| `DENY_AND_REROUTE` | Deny the request and redirect it to an external URL (e.g. a [tarpit](https://www.pcworld.com/article/2592071/one-rebels-malicious-tar-pit-trap-is-driving-ai-scrapers-insane.html))). |
...
### Deny and Reroute Configuration
